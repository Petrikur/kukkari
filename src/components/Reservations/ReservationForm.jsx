        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <div className="flex flex-col">
            <label
              ...
              className="text-white text-center pb-2 font-bold"
            >
              Varaaja
            </label>
            <input
              type="text"
              id="reservationName"
              className="border rounded-md border-gray-300 p-3 disabled bg-gray-300 font-bold w-full "
              value={auth.name}
              readOnly
          ...
          <div className="flex flex-col">
            <label
              htmlFor="description"
              className="text-white pb-2 text-center font-bold"
            >
              Lisätiedot (Ketä lähdössä, osuuko vai ei? jne)
            </label>
            <textarea
              id="description"
